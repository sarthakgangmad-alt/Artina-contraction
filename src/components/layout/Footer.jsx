        ...
        <footer className="bg-stone-950 text-white py-16 border-t border-stone-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div>
                        <h3 className="text-2xl font-bold mb-6 tracking-tighter uppercase">Artina Contracting Inc</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-stone-400">
                            <li>111 Riverview Ave</li>
                            <li>Woodbridge, Ontario, Canada</li>
                            <li>+1 416-660-3255</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="mt-16 pt-8 border-t border-stone-800 text-center text-stone-600 text-sm flex flex-col md:flex-row justify-between items-center">
                    <p>© {new Date().getFullYear()} Artina Contracting Inc. All rights reserved.</p>
